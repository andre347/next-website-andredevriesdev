...
const notActiveClassName =
  "text-gray-400 hover:bg-orange-400 hover:text-white block px-3 py-2 rounded-md text-base font-medium";
const activeClassName =
  "bg-orange-400 text-gray-600 block px-3 py-2 rounded-md text-base font-medium";
