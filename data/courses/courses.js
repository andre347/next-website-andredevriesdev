export default {
  id: "Courses",
  subTitle:
    "Ready to learn? Here is a list of all my video courses. You can watch all of them for free.",
  list: [
    {
      name: "Embedded Analytics with Tableau",
      description:
        "Learn how to embed a Tableau dashboard in a webpage with this video series. You will start from the basics, you learn how to get setup, how to embed your first dashboard and how to make this interact with your webpage.",
      slug: "embedding-tableau",
      videos: [
        {
          id: 0,
    ...
    {
      name: "Tableau Explained",
      description:
        "Upgrade your Tableau skills with this curated playlist of all my Tableau explainer videos. The main focus in this course is on Tableau Desktop. The videos are short and snappy.",
      slug: "tableau-explained",
      videos: [
        {
          id: 0,
          ...
          length: 240000,
          description:
            "Learn how to use a parameter to swap between sheets. This is a great, and easy, method for showing different types of charts in a dashboard. This allows the user to toggle between different charts.",
        },
        {
          id: 1,
          title: "How to Create a Donut Chart",
          url: "8Eysuu5eo6c",
          length: 240000,
          description:
            "In this video I explain how to create a donut chart in Tableau. The way you build such a chart is by overlaying two pie charts on top of each other.",
        },
        {
          id: 2,
          title: "How to Create a Viz in Tooltip",
          url: "ZoJcrDmTwsQ",
          length: 240000,
          description:
            "In this video I show you how to create a viz in tooltip. This allows the user to see more information when the tooltip shows up.",
        },
        {
          id: 3,
          title: "How to Create a Lollipop Chart",
          url: "huBhqjAXsT4",
          length: 180000,
          description:
            "In this video I explain how to create a lollipop chart in Tableau. This makes use of the 'dual axis' functionality of Tableau.",
        },
        {
          id: 4,
          title: "How to Create a Bar-in-Bar Chart",
          url: "4g3VonZmEAw",
          length: 180000,
          description:
            "In this video I explain how to create a bar in bar chart in Tableau. This visualisation type is great for comparisons.",
        },
      ],
    },
    {
      ...
      videos: [
        {
          ...
          length: 480000,
          description:
            "Learn how to quickly embed a Tableau dashboard into a Salesforce page",
        },
        {
          id: 1,
    ...
    {
      name: "Tableau Embedding Techniques",
      description:
        "Playlist containing some more advanced techniques around Embedding Tableau. You will learn how to Auto-refresh a dashboard on a timer, What trusted authentication is and also how to responsively auto-resize your dashboards.",
      slug: "tableau-embed-techniques",
      videos: [
        {
          id: 0,
          title: "Auto Refresh Embedded Tableau Dashboards",
          ...
          length: 720000,
          description:
            "In this video I show you how to use the Tableau JavaScript API to auto refresh embedded dashboards. ",
        },
        {
          id: 1,
          title: "What is Trusted Authentication in Tableau? An Illustration",
          url: "UmsuNrlroMs",
          length: 480000,
          description:
            "A question I get very often: how does Trusted Authentication work with embedded Tableau dashboards. In this video I try to demistify this concept.",
        },
        {
          id: 2,
          title: "Responsively Auto-resize Embedded Tableau Dashboards",
          url: "6yonB7OnzFw",
          length: 840000,
          description:
            "Quick video showing how to auto resize both automatic sized and fixed size dashboards so they fit the window.",
        },
      ],
    },
  ],
